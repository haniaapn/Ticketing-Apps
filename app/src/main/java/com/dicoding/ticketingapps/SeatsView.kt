...
class SeatsView: View {
    ...
    private fun drawSeat(canvas: Canvas?, seat: Seat) {
        //Mengatur warna if = sudah booking
        if(seat.isBooked){
        ...
        canvas?.drawPath(armrestPath, armestPaint)
        ...
        //Mengambalikan ke pengaturan sebelumnya
        canvas?.restore()
